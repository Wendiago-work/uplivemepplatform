      ...
      <div className="container">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-24 items-start">
          ...
          <div className="flex-1 w-full max-w-xl relative">
            ...
            <div className="bg-surfaceSecondary rounded-[40px] p-8 md:p-12 relative overflow-visible">
              <p className="text-[20px] mb-10 leading-relaxed pr-8">
                We are ready to discuss the details of your project and answer
              ...
              <form className="space-y-8 flex flex-col">
                ...
                <div className="pt-4 self-center">
                  <Button variant="tech" size="lg" className="font-bold">
                    SUBMIT REQUEST
                  </Button>
                </div>
              </form>
