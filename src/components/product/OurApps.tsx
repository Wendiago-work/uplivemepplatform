...
const apps: App[] = [
  ...
  },
  {
    ...
    description:
      "Professional tools for content creators to manage and grow their audience.",
    link: "#creator-studio",
  },
];
  ...
  return (
    <section className="relative rounded-tl-[20px] rounded-br-[20px]">
      ...
      <div className="container">
        ...
        <div className="mb-8">
          <Title as="h2" className="mb-4">OUR APPS</Title>

          <div className="flex flex-col lg:flex-row items-start lg:items-center gap-5">
            <p className="text-[20px] flex-1 max-w-2xl">
              Discover our innovative applications designed to connect people
