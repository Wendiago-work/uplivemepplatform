...
const techOutlineShapeClasses =
  "group/roll relative inline-flex items-center justify-center font-['Refinery95'] text-[#DBDAE2] border-0 cursor-pointer transition-all duration-300 ease-out h-auto shadow-none rounded-none overflow-hidden w-auto whitespace-normal text-center leading-tight [clip-path:polygon(15px_0,100%_0,100%_calc(100%_-_15px),calc(100%_-_15px)_100%,0_100%,0_15px)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background before:content-[''] before:absolute before:inset-0 before:z-[-1] before:bg-[linear-gradient(to_left_top,hsl(var(--primary))_50%,transparent_50.1%),linear-gradient(to_right_bottom,hsl(var(--primary))_50%,transparent_50.1%)] before:bg-[length:0%_0%] before:bg-no-repeat before:bg-[position:100%_100%,0%_0%] before:transition-[background-size] before:duration-300 before:ease-out hover:before:bg-[length:100%_100%] hover:text-white";
...
const techOutlineContainerClasses =
  "group/roll relative inline-flex items-center justify-center font-['Refinery95'] text-[#DBDAE2] border-0 cursor-pointer transition-all duration-300 ease-out h-auto shadow-none rounded-none w-auto whitespace-normal text-center leading-tight focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background hover:text-white hover:-translate-y-0.5 hover:shadow-[0_10px_20px_rgba(92,71,222,0.3)]";

const techOutlineBackgroundClasses =
  "absolute inset-0 -z-10 bg-transparent backdrop-blur-md before:content-[''] before:absolute before:inset-0 before:z-[-1] before:bg-[linear-gradient(to_left_top,hsl(var(--primary))_50%,transparent_50.1%),linear-gradient(to_right_bottom,hsl(var(--primary))_50%,transparent_50.1%)] before:bg-[length:0%_0%] before:bg-no-repeat before:bg-[position:100%_100%,0%_0%] before:transition-[background-size] before:duration-300 before:ease-out group-hover/roll:before:bg-[length:100%_100%]";
...
const TechBorder = () => (
  <>
    {/* Top */}
    <span className="absolute top-0 left-[15px] right-0 h-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE]" />
    {/* Bottom */}
    <span className="absolute bottom-0 left-0 right-[15px] h-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE]" />
    {/* Left */}
    <span className="absolute top-[15px] bottom-0 left-0 w-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE]" />
    {/* Right */}
    <span className="absolute top-0 bottom-[15px] right-0 w-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE]" />
    {/* TL Diagonal */}
    <span className="absolute top-[15px] left-0 w-[22px] h-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE] origin-top-left -rotate-45" />
    {/* BR Diagonal */}
    <span className="absolute bottom-[15px] right-0 w-[22px] h-[1px] bg-[#DBDAE2] transition-colors duration-300 group-hover/roll:bg-[#5C47DE] origin-bottom-right -rotate-45" />
  </>
);
